...
import "./client-only-CGD5-uml.js";
import "C:/Users/lucas/Desktop/Studium/8. Semester/Web-Engineering/Web-Engineering_repo/node_modules/klona/dist/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><section class="bewerbung-header" style="${ssrRenderStyle({ "margin-bottom": "20px" })}"><div class="icon-row"><img${ssrRenderAttr("src", _imports_0)} alt="Icon links" class="bewerbung-icon"><h1 class="bewerbung-title">Bewerbung für deinen Studienplatz</h1><img${ssrRenderAttr("src", _imports_1)} alt="Icon rechts" class="bewerbung-icon"></div></section><section class="form-page"><div class="form-container"><h2 class="section-title">Bewerbungsformular</h2><form>`);
      if (step.value === 1) {
      ...
      _push(`<div class="button-group" style="${ssrRenderStyle({ "margin-top": "20px" })}"><button type="button"${ssrIncludeBooleanAttr(step.value === 1) ? " disabled" : ""} style="${ssrRenderStyle({ "margin-right": "10px" })}"> Zurück </button>`);
      if (step.value < 3) {
...
//# sourceMappingURL=bewerbung-bXu73b1_.js.map
